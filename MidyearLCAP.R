...
advice <- data %>%
    mutate(`MidYear Advice` = case_when(str_detect(str_to_lower(Metric), " 1 a| 1a") ~ "Likely can report" ,
                                        str_detect(str_to_lower(Metric), "credential| appropriately assigned") ~ "Likely can report", 
                                        ...
                                        str_detect(str_to_lower(Metric), "state academic standards|performance standards") ~ "Likely can report" ,
           ...
           `Possible Data Source` = case_when(str_detect(str_to_lower(Metric), " 1 a| 1a") ~ "CDE will release a new data file in November;  historically done with internal school records",
                                     str_detect(str_to_lower(Metric), "credential| appropriately assigned") ~ "CDE will release a new data file in November;  historically done with internal school records",
                                     ...
                                     str_detect(str_to_lower(Metric), "state academic standards|performance standards") ~ "Locally determined, possibly Class schedules" ,
